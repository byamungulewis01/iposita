...
class IpositaTopupExport implements FromCollection,WithTitle,WithHeadings,WithEvents,ShouldAutoSize
{
    use Exportable;

    protected $query;

    public function __construct($query, $title="System Top-ups")
    {
        $this->query = $query;
        $this->title = $title;
    }
