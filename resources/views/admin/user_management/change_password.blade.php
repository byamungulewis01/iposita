        ...
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-2 mr-5">Change Password</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
        ...
        <div class="d-flex flex-row">
                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <div class="text-muted">{{Auth::user()->job_title}}</div>
                            </div>
                            @endcan
                        </div>
                        <!--end::User-->
            ...
            <div class="flex-row-fluid ml-lg-8">
                ...
                <div class="card card-custom">
                    ...
                    <!--end::Header-->
                    <!--begin::Form-->
                    <form class="kt-form kt-form--label-right" id="change-password-form" method="POST" action="{{route("admin.user.update.password")}}">
                        @csrf
                        <div class="card-body">
                            <!--begin::Alert-->
